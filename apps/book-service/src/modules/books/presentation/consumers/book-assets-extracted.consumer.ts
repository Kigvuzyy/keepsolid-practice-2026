...
@Controller()
export class BookAssetsExtractedConsumer {
	private readonly logger = new Logger(BookAssetsExtractedConsumer.name);
	...
	public async handleAssetsExtracted(
		...
		await this.txHost.withTransaction(async () => {
			...
			await this.commandBus.execute(
				new HandleBookCoverExtractedCommand({
					eventId,
